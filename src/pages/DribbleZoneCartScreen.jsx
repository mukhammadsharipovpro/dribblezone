...
import DribbleZoneCartItemComponent from '../components/DribbleZoneCartItemComponent';
import DribbleZoneComponent from '../components/DribbleZoneComponent';
...
export default function () {
  ...
  const handleOrder = () => {
    const destinationScreen = cart.length
      ? 'DribbleZoneCartSuccessScreen'
      : 'DribbleZoneHomeScreen';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <DribbleZoneCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
